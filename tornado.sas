...
title 'Model with Tornadoes';
proc genmod data=tornado;
       model deaths = tornadoes / dist=p link=log;
	 run;
 
title 'Model with Killer tornadoes';
proc genmod data=tornado;
         model deaths = killer_tornadoes/ dist=p link=log;
	 run;

	 
title 'Model with Tornadoes and Killer tornadoes';
proc genmod data=tornado;
         model deaths = tornadoes killer_tornadoes/ dist=p link=log;
	 run;
...
proc genmod data=tornado;
     class month_number;
     model deaths = killer_tornadoes month_number / dist=p link=log type3;
	 run;
