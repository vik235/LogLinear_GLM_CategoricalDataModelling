...
* In here SCORE stat is similar to Chi Sq statistic given by proc freq and is also equal to CMH stat;
...
proc logistic des; freq count; class alcohol(ref=last)/param=ref;
